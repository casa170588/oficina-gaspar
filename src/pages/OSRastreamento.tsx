...
import { Camera, FileDown, Plus, Trash2, ImageIcon, Search, AlertTriangle, Radar, Save } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="card-floating p-6">
        ...
        <div className="relative mb-4">
          ...
          <input value={buscaPeca} onChange={(e) => setBuscaPeca(e.target.value)} className="input-neon w-full pl-10" placeholder="Buscar peça por nome ou código de referência..." />
        </div>
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {pecasFiltradas.length === 0 && <p className="text-sm text-muted-foreground">Nenhuma peça de rastreamento encontrada.</p>}
        </div>
      ...
      <div className="flex flex-wrap gap-3">
        <Button variant="neonCyan" size="lg" onClick={salvarOS}>
